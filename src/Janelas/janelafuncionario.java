...
public class janelafuncionario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txlogin.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(255, 255, 0)));

        txsenha.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(255, 255, 51)));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txsenha, javax.swing.GroupLayout.DEFAULT_SIZE, 185, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       Connection con = conexao.conexaoBanco.AbrirConexao();//abre o banco pela conexão
        funcionario fn = new funcionario ();//puxa a classe funcionario
       AcessoDAO ac = new AcessoDAO(con);
        PessoaDAO pc =new PessoaDAO();//puxa o acesso
       fn.setLogin(txlogin.getText()); //dados do funcionario
       fn.setSenha(txsenha.getText());
       
         if(pc.VerificarLoginfu(txlogin.getText(),txsenha.getText())){  //verifica se os dados estão corretos
